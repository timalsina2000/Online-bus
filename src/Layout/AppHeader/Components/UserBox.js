...
const UserBox = () => {
 ...
 const handleLogout = () => {
    ...
    //   this.props.onLogout();
    // } else {
    //   console.warn("onLogout function not provided as prop to UserBox");
    // }
  };
          ...
          <div className="widget-content p-0">
            <div className="widget-content-wrapper">
              <div className="widget-content-left">
                <UncontrolledButtonDropdown>
                  <DropdownToggle color="link" className="p-0">
                    <img width={42} className="rounded-circle" src={city3} alt=""/>
                    <FontAwesomeIcon
                          ...
                          <div className="widget-content p-0">
                            <div className="widget-content-wrapper">
                              ...
                              <div className="widget-content-right me-2">
                                <Button onClick={handleLogout} className="btn-pill btn-shadow btn-shine" color="focus">
                                  Logout
                                </Button>
                              </div>
                            </div>
              ...
              <div className="widget-content-left  ms-3 header-user-info">
                <div className="widget-heading">siddhartha timalsina</div>
