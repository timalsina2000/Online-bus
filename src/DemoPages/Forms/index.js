...
// Forms
import FormElementsLayouts from "./Elements/Layouts/allcategories";

import FormElementsLayouts1 from "./Elements/Layouts/newcategories";
import FormElementsLayouts2 from "./Elements/Layouts/newpost";
import FormElementsLayouts3 from "./Elements/Layouts/menu";
import FormElementsLayouts4 from "./Elements/Layouts/Allpost";
import FormElementsLayouts5 from "./Elements/Layouts/Bookedticket";

import SeatSelection from "./Elements/Layouts/Allpost/Examples/SeatSelection";
    ...
    <div className="app-main">
      ...
      <div className="app-main__outer">
        <div className="app-main__inner">
          ...
          <Route path={`${match.url}/add-post`} component={FormElementsLayouts2}/>
          <Route path={`${match.url}/new-categories`} component={FormElementsLayouts1}/>
          <Route path={`${match.url}/new-menu`} component={FormElementsLayouts3}/>
          <Route path={`${match.url}/new-post`} component={FormElementsLayouts4}/>
          <Route path={`${match.url}/book-post`} component={FormElementsLayouts5}/>
          ...
          <Route path={`${match.url}/seat-selection/:slug`} component={SeatSelection} />
